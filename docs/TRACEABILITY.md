...
| Conservative Vite/Nuxt/Astro CLI alignment (argv on the framework binary only; env for all runs) | NOOK-62, NOOK-72, NOOK-71, NOOK-67, NOOK-73, NOOK-68 | `framework::tests::*`; `config::tests::framework_*`; CLI `--framework` / `--no-framework` |
